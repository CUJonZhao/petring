#pragma once
// Trusted roots for the HTTPS sync endpoint. The site currently chains to GTS Root R4;
// GTS R1 and ISRG X1/X2 keep uploads working if the hosting CA rotates.
// mbedTLS parses every PEM block in this buffer. SHA-256 fingerprints:
...
static const char kCloudRootCA[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
